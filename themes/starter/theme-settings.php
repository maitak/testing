...
function starter_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['#validate'][] = 'starter_theme_settings_validate';
  $form['#submit'][] = 'starter_theme_settings_submit';
...
function starter_theme_settings_validate(&$form, &$form_state) {
  
}

function starter_theme_settings_submit(&$form, &$form_state) {
